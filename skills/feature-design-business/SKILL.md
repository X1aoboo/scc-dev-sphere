...
- **输出:** `artifacts/business-design.md`、evidence 快照、`decisions/business-design-decisions.md`、对 solution-design 的交接契约
...
- 关键取舍写 DEC ID 到 `decisions/business-design-decisions.md`。
...
1. 在 `decisions/business-design-decisions.md` 记录修订原因。
