...
| 设计通用能力 | [`design-draft`](skills/design-draft/SKILL.md)、[`design-reopen`](skills/design-reopen/SKILL.md)、[`design-archive`](skills/design-archive/SKILL.md)、[`design-active`](skills/design-active/SKILL.md)、[`design-manual-change`](skills/design-manual-change/SKILL.md) |
